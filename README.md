...
- **Контекстная память диалога**: Сохранение истории сообщений в рамках одной сессии
...
- [ ] Переход на персистентное хранилище сессий (Redis) для исключения потери диалогов при перезапуске
